...
for frame in (preferensipage,pilihan):
    frame.grid(row=0,column=0,sticky='nsew')                                        # tata letak halaman
...
#======================================================Background===================================================
label = Label(hlmn)
bg = PhotoImage(file='15.png')
a_label = Label(hlmn, image=bg)
...
kembali = Button(hlmn,text='BACK',font=('Segoe Print',17,'bold'),bd=0,bg='#82301A',
                    fg='#FCFDFE',cursor='hand2',activebackground='#F6D58E',
...
kembali3 = Button(preferensipage,text='BACK',font=('Segoe Print',17,'bold'),bd=0,bg='#82301A',
                    fg='#FCFDFE',cursor='hand2',activebackground='#F6D58E',
                    activeforeground='#82301A',width=12,height=1,command=lambda:show_frame(pilihan))
...
def muter3():
    ...
    kembali3 = Button(latar3,text='BACK',font=('Segoe Print',17,'bold'),bd=0,bg='#82301A',
...
def muncul1():
    ...
    food = data["Pedas"][random.randint(0,len(data["Pedas"]))]
    gambar = ImageTk.PhotoImage(Image.open(food["gambar"]))
...
def muncul2():
    ...
    food = data["TanpaSeafood"][random.randint(0,len(data["TanpaSeafood"]))]
    gambar = ImageTk.PhotoImage(Image.open(food["gambar"]))
...
def muncul3():
    ...
    food = data["RendahKalori"][random.randint(0,len(data["RendahKalori"]))]
    gambar = ImageTk.PhotoImage(Image.open(food["gambar"]))
...
def muncul4():
    ...
    food = data["P&TS"][random.randint(0,len(data["P&TS"]))]
    gambar = ImageTk.PhotoImage(Image.open(food["gambar"]))
...
def muncul5():
    ...
    food = data["TS&RK"][random.randint(0,len(data["TS&RK"]))]
    gambar = ImageTk.PhotoImage(Image.open(food["gambar"]))
...
def muncul6():
    ...
    food = data["R&RK"][random.randint(0,len(data["PRK"]))]
    gambar = ImageTk.PhotoImage(Image.open(food["gambar"]))
...
def muncul7():
    ...
    food = data["All"][random.randint(0,len(data["All"]))]
    gambar = ImageTk.PhotoImage(Image.open(food["gambar"]))
